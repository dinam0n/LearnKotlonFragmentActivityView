package ru.myproject.learnkotlonfragmentactivityview
...
import ru.myproject.learnkotlonfragmentactivityview.databinding.FragmentFirstBinding
...
class FirstFragment:Fragment(R.layout.fragment_first) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener(RESULT_REQUEST_KEY, this){ key, bundle->
            handleResult(bundle) //вызовем обработку внутри слушателя
        }
    }
